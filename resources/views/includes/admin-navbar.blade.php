                ...
                <ul>
                    <li class="{{ Request::is('dashboard') ? 'active' : '' }}">
                        <a href="{{route('dashboard-details')}}">
                            <img class="active-icon" src="{{asset('assets/images/dots-icon.svg')}}"
                                alt="dashboard-icon">
                            <img class="normal-icon" src="{{asset('assets/images/dots-icon-gray.svg')}}"
                    ...
                    <li>
                        <a href="{{route('user')}}">
                            <img class="active-icon" src="{{asset('assets/images/user-icon-active.svg')}}"
                                alt="user-icon">
                    ...
                    <li>
                        <a href="{{route('transactionList')}}">
                            <img class="active-icon" src="{{asset('assets/images/transection-icon-active.svg')}}"
                                alt="transection-icon">
                            <img class="normal-icon" src="{{asset('assets/images/transection-icon.svg')}}"
                                alt="transection-icon">
                            All Transaction
                        </a>
                    </li>
                    <li>
                        <a href="{{route('setting-details')}}">
                            <img class="active-icon" src="{{asset('assets/images/setting-icon-active.svg')}}"
                                alt="setting-icon">
                            <img class="normal-icon" src="{{asset('assets/images/setting-icon.svg')}}"
                                alt="setting-icon">
                            Settings
                        </a>
                    </li>
                    <li>
                        <a href="{{route('support-page')}}">
                            <img class="active-icon" src="{{asset('assets/images/support-icon -active.svg')}}"
                                alt="support-icon">
                            <img class="normal-icon" src="{{asset('assets/images/support-icon.svg')}}"
                                alt="support-icon">
                            Support
                        </a>
                    </li>
            ...
            <div class="bell-section-area">
                <div class="bell-icon">
                    ...
                    <div class="form-group has-search">
                        <div class="dropdown">
                            <img src="{{ asset('assets/images/bell-notify-icon.svg') }}"
                                class="dropdown-toggle icon-button" id="dropdownMenuButton" data-toggle="dropdown">
                            <span class="noti-dot">3</span>
                            <div class="dropdown-menu notification-dropdown px-2" aria-labelledby="dropdownMenuButton">
                                <a class="notification-area " href="#">
                                    <div class="notification-profile d-flex py-3 error-notification">
                                        ...
                                        <p class="pl-3">Unfortunately, Your Topup transaction was not successful due to
                                ...
                                <a class="notification-area " href="#">
                                    <div class="notification-profile d-flex py-3 success-notification">
                                        ...
                                        <p class="pl-3">Topup <span>successfully</span> sent to Ali <br>Thank you for
                                            using Amin Topup!</p>
                                    </div>
                                </a>
                                <a class="notification-area " href="#">
                ...
                <div class="admin-top-dropdown">
                    <div class="dropdown nav-right-button">
                        <button class="btn dropdown-toggle logout-button" type="button" data-toggle="dropdown"
                            aria-expanded="false">
                        ...
                        <div class="dropdown-menu log-out">
                            <a class="dropdown-item" href="#"> <img src="{{asset('assets/images/logout.svg')}}" alt="">
                                Logout</a>
                            <a class="dropdown-item" href="{{url('changepassword')}}"> <img
                                    src="{{asset('assets/images/padlock.png')}}" alt="">Change Password</a>
                        </div>
